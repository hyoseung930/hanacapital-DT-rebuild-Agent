...
import favicon from '@/assets_agent/images/common/favicon.ico';
import DefaultLayout from '@/layouts_agent/DefaultLayout.vue';
import NoneLayout from '@/layouts_agent/NoneLayout.vue';
import LoadingLayer from '@/components_agent/ui/layout/LoadingLayer.vue';
