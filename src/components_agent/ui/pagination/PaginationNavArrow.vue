...
import IconPrev from '@/assets_agent/images/icon/pagination-prev.svg?component';
import IconNext from '@/assets_agent/images/icon/pagination-next.svg?component';
