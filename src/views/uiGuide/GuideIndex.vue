  ...
  },
  {
    ...
    datas: [
      ...
      },
      {
        depth2: '내구재할부',
        depth3: '팝업',
        depth4: '판매점 제휴 협약을 위한 개인(신용)정보동의 URL발송',
        depth5: '',
        depth6: '',
