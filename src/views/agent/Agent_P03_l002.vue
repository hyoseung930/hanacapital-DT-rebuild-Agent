...
<template>
  <UiLayer ref="layer" v-slot="layerSlotProps">
    <ModalPopup size="large">
      ...
      <section class="row-margin-container-medium">
        <section class="row-margin-container-medium">
          <h3 class="text-title-1 row-margin-contents">녹취 동의</h3>
      ...
      <section class="row-margin-container-medium">
        <section class="row-margin-container-medium">
          <h3 class="text-title-1 row-margin-contents">녹취 내용</h3>
                ...
                <tr>
                  ...
                  <td>
                    <div class="scroll-container mxh-300">
                      ...
                      통신사 및 휴대폰번호를 말씀해주시겠습니까? 네.
                      감사합니다.<br />
                      지금 보내드린 인증번호를 말씀해주시겠습니까?<br />
                      네. 본인확인이 완료되었습니다.<br />
                      ■ 개인신용정보조회 동의 스크립트<br />
                      상담을 위해 당사는 고객님의 신용정보와 고유식별정보를
                      수집,이용,조회하고 신용정보회사에게 제공할 수 있습니다.
                      단순 상담만으로는 신용등급에 영향이 없습니다. 기타 자세한
                      사항은 하나캐피탈 홈페이지에서 확인바랍니다.<br />
                      1.고객님의 개인신용정보 수집/이용/조회/제공에
                      동의하시나요?<br />
                      2.고객님의 고유식별정보 수집/이용/조회/제공에
                      동의하시나요?<br />
